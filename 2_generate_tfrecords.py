...
TRAIN_CSV_FILE_LOC = os.getcwd() + "/images" +  "/training_data/" + "train_labels.csv"
TRAIN_IMAGES_DIR = os.getcwd() + "/images" + "/training_images"

# input test CSV file and test images directory
EVAL_CSV_FILE_LOC = os.getcwd() + "/images" + "/training_data/" + "eval_labels.csv"
TEST_IMAGES_DIR = os.getcwd() + "/images" + "/test_images"

# training and testing output .tfrecord files
TRAIN_TFRECORD_FILE_LOC = os.getcwd() + "/images" +  "/training_data/" + "train.tfrecord"
EVAL_TFRECORD_FILE_LOC = os.getcwd() + "/images"  + "/training_data/" + "eval.tfrecord"
